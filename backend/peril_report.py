...
<div class="page">
  ...
  <div style="padding:16px 44px 0; flex:1; display:flex; flex-direction:column;">
    ...
    <div style="border:1px solid #d9e4f0; border-radius:3px; display:grid; grid-template-columns:1fr 1fr 1fr;">
      ...
      <div style="padding:9px 16px; border-right:1px solid #e7eef6; grid-column:span 2; min-width:0;"><div style="font-size:8.5px; letter-spacing:.1em; text-transform:uppercase; color:#7d8ea1; font-weight:600;">Property Address</div><div style="font-size:13px; color:#0c1a30; font-weight:600; margin-top:2px; overflow-wrap:anywhere;">{hc.soft_wrap_html(data["propertyAddress"])}</div></div>
      <div style="padding:9px 16px;"><div style="font-size:8.5px; letter-spacing:.1em; text-transform:uppercase; color:#7d8ea1; font-weight:600;">Claim / Reference</div><div style="font-size:13px; color:#0c1a30; font-weight:600; margin-top:2px;">{hc.soft_wrap_html(data["claimRef"], 26)}</div></div>
