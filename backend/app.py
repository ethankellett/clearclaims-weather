...
def _run(req: GenerateRequest, user: str = "") -> dict:
    ...
    meta = {
        ...
        "radar_quality": result.get("radar_quality"),
        "geocode_precision": result.get("geocode_precision"),
        "prior_hail": result.get("prior_hail"),
        "nws_warned": result.get("nws_warned"),
        "same_day_gust_mph": result.get("same_day_gust_mph"),
...
def generate(req: GenerateRequest, request: Request,
    ...
    return {
        ...
        "radar_quality": m.get("radar_quality"),
        "geocode_precision": m.get("geocode_precision"),
        "prior_hail": m.get("prior_hail"),
        "nws_warned": m.get("nws_warned"),
        "same_day_gust_mph": m.get("same_day_gust_mph"),
